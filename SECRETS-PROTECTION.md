...
You can see a [worked example](https://github.com/approov/quickstart-unity-web-request/blob/master/SHAPES-EXAMPLE.md#shapes-app-with-secrets-protection) for the Shapes app.
